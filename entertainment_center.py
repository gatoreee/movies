...
goodfellas = media.Movie("Goodfellas", "Henry Hill and his friends work their way up through \
	the mob hierarchy", "http://wallpapers111.com/wp-content/uploads/2015/03/\
	goodfellas-wallpaper-hd.jpg", "https://youtu.be/YH-7he92XfI")

shawshank_redemption = media.Movie("The Shawshank Redemption", "Two imprisoned men bond over \
	a number of years, finding solace and eventual redemption through acts of common \
	decency", "http://upload.wikimedia.org/wikipedia/en/8/81/\
...
mama_tambien = media.Movie("Y Tu Mama También", "In Mexico, two teenage boys and an attractive \
	older woman embark on a road trip and learn a thing or two about life, friendship, sex, and \
	each other", "https://upload.wikimedia.org/wikipedia/en/6/63/\
	Y_tu_mamá_también_poster.png", "https://youtu.be/3Qg6n7V3kO4")

sideways = media.Movie("Sideways", "Two men reaching middle age with not much to show but \
	disappointment, embark on a week long road trip through California's wine country, just \
	as one is about to take a trip down the aisle", "http://upload.wikimedia.org/wikipedia/en\
	/f/ff/Sideways_poster.JPG", "https://youtu.be/YS9ocP6FNvM")
